...
HS_EMTEntry_t HS_EventMon_Tbl[HS_MAX_MONITORED_EVENTS] = {
    ...
    /*   1 */
    { "CFE_EVS",  0, 10, HS_EMTActType_NOACT },
    /*   2 */
    { "CFE_TIME", 0, 10, HS_EMTActType_NOACT },
    /*   3 */
    { "CFE_TBL",  0, 10, HS_EMTActType_NOACT },
    /*   4 */
    { "CFE_SB",   0, 10, HS_EMTActType_NOACT },
    /*   5 */
    { "SC",         0, 10, HS_EMTActType_LAST_NONMSG + 2 },
    /*   6 */
    { "SAMPLE_APP",         0, 10, HS_EMTActType_APP_RESTART },
    /*   7 */
