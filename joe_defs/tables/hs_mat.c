...
HS_MatTableEntry_t HS_MsgActs_Tbl[HS_MAX_MSG_ACT_TYPES] = {
    ...
    { .EnableState = HS_MATState_ENABLED,
     .Cooldown    = 10,
     .HsMsg.cmd1  = { CFE_MSG_CMD_HDR_INIT(CFE_TBL_CMD_MID,
                                           HS_MEMBER_SIZE(cmd1),
                                           CFE_TBL_NOOP_CC,
                                           CFE_TBL_NOOP_CKSUM) }                                                       },
    /*   1 */
    ...
    { .EnableState = HS_MATState_DISABLED,
     .Cooldown    = 10,
     .HsMsg
          .cmd1 = { CFE_MSG_CMD_HDR_INIT(CFE_TBL_CMD_MID, HS_MEMBER_SIZE(cmd1), CFE_TBL_NOOP_CC, CFE_TBL_NOOP_CKSUM) } }
};

CFE_TBL_FILEDEF(HS_MsgActs_Tbl, HS.MsgActs_Tbl, HS MsgActs Table, hs_mat_tmp.tbl)